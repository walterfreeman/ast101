...
Below, sketch the Moon phase as it appears on the given date. Don't worry too much about whether the ``left'' or ``right'' side of the Moon is lit; this varies from place to place on Earth and at different times of year. This is because the lit part of the Moon is always pointed toward the Sun, and as you know, the path of the Sun in the sky depends on the season and latitude.\\
\begin{align*}
& \ \ \ \ 9/10 & 
& \ \ \ \ 9/14 &
& \ \ \ \ 9/17 &
...
& \ \ \ \ 10/6 &
& \ \ \ \ 10/10\\
& \includegraphics[scale=0.52]{blank_moon} &
& \includegraphics[scale=0.52]{blank_moon} &
& \includegraphics[scale=0.52]{blank_moon} &
& \includegraphics[scale=0.52]{blank_moon} &
& \includegraphics[scale=0.52]{blank_moon} &
