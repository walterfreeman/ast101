...
\large
\BI
\item Quiz 6 retake (only) will be today end of class (20 min / 10 questions)
\item Unit 7 (the solar system and climate change) and Unit 8 (spaceflight) will only be on the final
\item Homework 7 assigned today or tomorrow, due in two weeks
\pause
\item A bug in my quiz grading program meant that some people's grades were off by one
\item If this bug hurt you, I've corrected your scores
\item if this bug helped you, you get to keep the higher grade :)
\EI
}

\frame{\frametitle{\textbf{Announcements}}
\Large
I am currently arguing with the registrars about getting a space to do 
end of term quiz makeups/retakes :(

\bigskip\pause

I would like to do this {\bf Saturday, December 11}.

\bigskip\pause

I am going to send out two Google forms over Thanksgiving:

\large

\begin{itemize}
	\item {\color{A} One asking about people who need to make up a lab}
	\item {\color{B} One asking about people who want to retake a quiz, or take the final early}
\end{itemize}

\bigskip\Large

You {\it \color{C} must} answer these if you want to do either -- we need to make sure there is space for you and arrange for you to have a lab group.

}
%
%\frame{\frametitle{\textbf{A look at the rest of the term}}
%\large
%We're now in the last portion of our course: ``where we've come from, and where we're going''. We'll study:
%
%\BS
%
%\large
