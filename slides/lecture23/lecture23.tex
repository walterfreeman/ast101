...
\large
\BI
\item Quiz 6 retake (only) will be on Thursday at the end of class (20 min / 10 questions)
\item Unit 7 (the solar system and climate change) and Unit 8 (spaceflight) will only be on the final
\item Homework 7 assigned Thursday (not today)
\item Today's slides cover both today and Thursday's class
\pause
\BS
\item There is a prelab for this week, but it is not mandatory for labs today and tomorrow because I posted it late. (You should still do it if you have time!)
\EI
}
