...
\rm
\begin{flushright}
	--Yuri Gagarin, first human in space, \\ upon landing from his first flight in 1961
\end{flushright}
...
This quote, and others pertaining to the voyage to the Moon and the quest for the stars, were set
by Christopher Tin in his oratorio ``To Shiver the Sky''.

\BS

I discovered it just this morning, and listened to it while preparing for class today.

\BS
\BS

Give it a listen if you want: \url{https://www.youtube.com/playlist?list=PLMfqyskB8JL8fNbX2h_4h1zUKNMAHOiv3}
...
\frame{\frametitle{\textbf{Announcements: makeups/retakes}}
	\large
	I am in the process of arranging the schedule for makeup labs. If you signed up to make up a lab, expect a note from me tonight or tomorrow morning.
	\bigskip\BS
	
	I'll be in my office (215) or the Physics Clinic most of the day Friday. Come by if you want to chat about anything.
...
\frame{\frametitle{\textbf{Announcements: final project submissions}}
	...
	\pause
	\item To me in my office, on December 9
...
\frame{\frametitle{\textbf{Announcements: take-home lab}}
	\large
	\BC {\color{B} \bf The take-home lab is due this Friday, 10 December.} \EC
	...
	Since you can drop your lowest lab grade, this won't affect your grade too badly.
...
\frame{\frametitle {\textbf{Preparing for the final exam}}
	...
	\item {\color{Red} Section 1 (12:30): Giffords Auditorium, in Huntington-Beard Crouse ({\color{A}not here)}}
...
\frame{\frametitle {\bf Preparing for the final exam: review sessions}
	\BI
	\item Office hours Wednesday/Friday as usual
	\BS
	...
	\item \color{B} Previous quizzes \pause-- as the sorts of ways we evaluated you on these things\pause
