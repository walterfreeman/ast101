...
Some of us will go on to become doctors -- not of physics or literature or engineering, but {\it philosophy}.
...
How does a propeller work? {\color{C}``The airplane pushes backwards on the air; the air pushes forwards on the airplane''.}

\pause\BS\BS

{\color{C}``A spaceplane pushes backwards on the ... drat, there's no air in space.''}
...
The Russian scientist Konstantin Tsiolkovsky (1857-1935) was the first to study the physics of rocketry in depth. 
...
Not everyone was convinced, as you saw on Exam 2:
...
They we not very good weapons because they weren't accurate, but were terrifying.
...
The widow of one of them lived across the street from me when I was a child. Another taught English at the local high school after retiring from NASA.
...
\HC
\BI
\item Apollo I (1967): crew chamber pressurized with pure $\text O_2$
...
Margaret Hamilton, leader of the MIT team that developed the flight computer software for {\it Apollo}, who pioneered the field of software engineering\EC
\ECC
}
