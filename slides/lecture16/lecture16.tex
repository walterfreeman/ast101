...
\Large
\begin{itemize}
	\item Homework 5 will be posted tonight.
	\item Prelab 7 will be posted tonight. (You will do it electronically.)
	\item Blackboard reflects your grades from Quiz 2, but {\it not} the retake.
	
	\bigskip\bigskip\large
	\item If you're worried about quiz scores, come talk to me tomorrow morning
	\begin{itemize}
		\item Office hours: 9am-11pm tomorrow
		\item Held in room 112 as always
	\end{itemize}
\end{itemize}
}
...
\frame{\frametitle{\textbf{Paper 2}}
	\Large
	\BI
	\item Paper 2's assignment is posted. (It will be modified slightly tonight.)
	\item It is due two weeks from tomorrow.
	\pause
	\bigskip
