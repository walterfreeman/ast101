...
\frame{
	\begin{center}
\includegraphics[height=0.97\textheight]{DSC_2999.jpg}
\end{center}
}
...
\Large
\BI
\item{Exam is next Tuesday}
\BI
\item Slack-message me if you are left handed and you haven't already
\EI
\item I'm behind on messages and will catch up soon
\EI
}
...
\Large
\BI
\item Help session in my office tomorrow, 9:30-11:30
\item I will lead a review in the Physics Clinic on Sunday, 2-5
\EI
}
...
\frame{
	\Large
	\begin{center}
		We want this to be the best class for you that we can.	This is your class more than it is mine!
		\bigskip
		\bigskip
		
		If you have any feedback for me -- anything that I can do differently, or anything that I can do
		to make your experience in here or in lab better -- please let me know.
		
		\bigskip
		\bigskip
		
		Especially if something is not going well, I want to hear your candid feedback.
		
		\bigskip
		\bigskip
		
		I had a long Slack conversation with a student last night about something that happened in lab that 
		she wasn't happy about, and was very glad to get her feedback.
...
\BI
\item{The material in the {\it Lecture Tutorials} and Lab 3}
\item{The material in the other labs}
...
\BC\Huge Any questions from last year's exam?\EC
