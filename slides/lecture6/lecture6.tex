...
The prelabs for next week are in the Physics Clinic and available online.
...
\frame{\frametitle{\textbf{Homework quiz 1}}
	
\large

\BI
\item We have graded all of your homework quizzes; we are working on entering the grades into Blackboard. \pause\BS
\item Some people did very well; others did less well. \pause
\item Remember in our class that 80-100\% is an A, 65\%-80\% is a B, etc. \pause
\item We ask you to do difficult things, and don't expect you to do them all perfectly
\BS
\item We will have opportunities for you to redo the homework quizzes:
\BI
\item At least one opportunity late in the semester
\item As part of Exam 1
\item In office hours
\EI
\BS
\item The idea is that we want you to have these skills by the end of the semester; if you learn them ``late'', you still learned them, and you should get credit.
\EI
}

\frame{\frametitle{\textbf{Homework quizzes}}
	
	\large
	The homework quizzes are supposed to reflect {\it your} skills, not the skills of your neighbors.
	
	\BS\BS\pause
	
	You {\color{B} should} collaborate with others in doing your homework, but you must take the homework quiz on your own.
	
	\BS\BS\pause
	
	We have identified some people who copied from their neighbors on the first homework quiz. {\color{A} Don't do this.}
	
	\BS\BS\pause
	
	We are not going to penalize you this time. We {\it will} do so next time. 
	
	\BS
	\BS\pause
	
	If you don't have the skills you need -- gain those skills, don't fake them. We'll give you another chance.
}


\frame{\frametitle{\textbf{Homework 2}}
\huge

\BC
Are there any questions about Homework 2?


\Large\BS\BS\pause
Homework 2's quiz will be next Tuesday; it will be 10 minutes at the end of class.

\BS\pause

\normalsize
(We expect the logistics to be smoother this time!)
\EC
}
%
%\frame{\frametitle{\textbf{Homework quizzes, generally}}
%	\Huge
%	
%	\BC
%	Are there any questions about Homework 2?
...
\frame{\frametitle{\textbf{Exercise from last time}}

\Large

\BC
Work on the exercise we handed out last time on the seasons.\\ (We have a few more copies.)

\BS\BS

\large
As always, raise your hand if you have questions and we'll chat with you.

\BS\BS

We'll take about 20 minutes on this, and then reconvene to talk about the Moon.
...
Other movements talk about springtime, sexuality, satire of the corrupt, drunkenness, and more sexuality; the work both opens and closes with this movement.
}

\frame{\frametitle{\textbf{Tell me about this picture...}}

		\begin{center}
				\includegraphics[width=0.7\textwidth]{alice-at-moonrise.jpg}
				\\
				
				\small\pause
				\it 14mm f/1.8, 6 second exposure, ISO 6400
				\BS\BS
				
				For those who aren't photographers: this means it was very dark.
		\end{center}
...
\item{\color{B}The Moon (today)}
\item{The planets (next week)}
\item{Oddities: comets, meteors, novas, eclipses... (next week)}
\EI
\end{minipage}
\begin{minipage}{0.49\textwidth}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{moon-crouse.jpg}
		
		\scriptsize \it Image from SU AST101 student ComradeWilhelm (on Discord), Fall 2020
	\end{center}
		\end{minipage}
}
...
\BI
\item{Traditional Chinese calendar (what is today?)} \pause
\item{Hebrew calendar}\pause
\item{Islamic hijra calendar} \pause
\EI
...
\begin{minipage}{0.49\textwidth}
		\begin{center}
	\includegraphics[width=0.9\textwidth]{moon-timmyney.jpg}
	\scriptsize
	\it 

	Image from AST101 student Timmyney (on Discord):
	\vspace{1.5em}
...
{\bf \color{Red}Do this} on inclass problems, your lab, exams...
\end{columns}
}
%
%\frame{
...
As seen from Syracuse, which part of a waning crescent moon will be lit?
