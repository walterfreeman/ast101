...
\BI
\item I think I've fixed the problems with github, so expect faster/more frequent updates
\EI
...
\item Please contact {\tt phyacademics@syr.edu} for registration questions/issues
\EI
\BS

\item Homework due Thursday
	\BI
\item We won't collect it
\item We'll have a ``homework quiz'' at the end of class
	\EI
\item If you have a Monday lab, you'll do Lab 1 next week
\EI
}

\frame{\frametitle{\textbf{Welcome survey}}
	Thanks to all who filled out the welcome survey!
	...
	\begin{itemize}
		...
		\item ``Hopefully more fun than stressful calculations.''
		\pause
		\item ``I am a but nervous being an arts kids as I was recently told the course is all math ... hoping that is not true''
		\pause
		\item ``a bit intimidated by the class size but I'm looking forward to it.''
		\pause
		\item ``nervous - physics was the worst grade I got in HS and they seem similar''
		\pause
		\item ``Nervous about the math and science part, math+science are not my strongest subjects.''
		\pause
		\item ``pretty excited! im not really a stem girly but i think that the universe is super beautiful and interesting so im excited to be involved in something new''
		\pause
		\BS\BS
		\item Lots and lots of variants of excitement!
	\end{itemize}
}
...
\frame{\frametitle{\textbf{Welcome survey}}
	...
	Stuff people hoped to learn:
	
	\begin{itemize}
		
		\item Spacetime
		\pause
		\item ``learning cool facts about the universe that i can annoy my family with''
		\pause
		\item The scope and scale of things
		\pause
		\item The constellations
		\pause
		\item Astrology, star-signs (Thursday!)
		\pause
		\item The history of all this!
		\pause
		\item Galaxies and their nature
		\pause
		\item The unexpected
	    \pause
	    \item Telescopes and the JWST
	    \pause 
	    \item Light
	    \pause
	    \item Telling time based on stuff in space
	    \pause
		\BS\BS
		\item Black holes :)
	\end{itemize}
...
\BI
\item AST101 help sessions: Wednesday 2-4, or Monday 10-12, in the Physics Clinic (room 112)
\pause
\item Other times in the Clinic (usually a tutor there)
\pause
\item Appointments with me by request
\pause 
\item By email or over Discord: most of you have cellphone cameras...
\EI
}
...
We won't always be ``going over'' them in class -- this deprives you of an opportunity.
...
\frame{\frametitle{\textbf{The homework}}
	\Large
	\BC
	We {\it will} almost always have time for you to ask some questions about the homework before the homework quiz.
	\EC
}
...
\item What are these ``Aries'', ``Gemini'', ``Capricornus'', and ``Scorpius'' things?
\item What is astrology (and what is it {\it really?})
\EI
}
...
\Large
\BC
Take 20-30 minutes to complete the exercise from before.
\EC
\BS\BS
Note: If you have not already done so, change the diagrams on all your handouts so that East is on top and West is on the bottom.

\BS

See our discussion for why!

\BC
\BS\BS

\color{B}
Make sure you talk to the people around you as you work! Raise your hand if you have questions and we'll come chat.
\EC
...
Over the course of one day, the Sun doesn't move very much in space relative to the Earth.
...
\frame{\frametitle{\textbf{A question for Thursday}}
	...
	\item \color{E} E: Whatever we decide it is
	\EI
}
