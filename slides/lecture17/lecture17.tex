...
\item If you have questions about your paper, come to office hours or ask on Discord.
\pause
\bigskip
...
\frame{\frametitle{\textbf{Announcements}}
	\BC
\Large
Homework Quiz 5 is Thursday. 

\BS\BS

The back page of your homework says what's on it, as usual.
\EC
}
	...
	\frame{\frametitle{\textbf{Final projects}}
		...
		\item Essays
		\item A tarot deck
		\item A constellation map of Middle-earth and a model of the Crown of Elbereth
		\item ...
		\EI
	}
\frame{\frametitle{\textbf{Final projects}}
	...
	As with the paper in this class, we do ``open-ended'' grading for these (you can earn more than 100\% for exemplary or inspiring work).
...
\Large
\BC
Work on your in-class exercise.

\BS
\BS
\normalsize
If you need a copy, we have extras.
\EC}
