...
\large
\BI
\item Paper 2 topic available for those absent previously
\item Next quiz Thursday
\item What would you prefer for the format?
\begin{itemize}
	\item \color{A}A: As before (quiz on paper, answers on paper)
	\item \color{B}B: Quiz on Blackboard, answers on paper
	\item \color{C}C: Quiz on Blackboard, answers on Blackboard
\end{itemize}
\EI
}
%
...
\BC
\Large
A friend sent me this two years ago, the day before this topic:
...
\item What can we learn about the sizes and temperatures of stars by their colors (Thursday before the quiz)
