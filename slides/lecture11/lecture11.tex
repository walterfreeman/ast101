...
\frame{\frametitle{\textbf{News}}
	
	\Large
	
	What's the news from you all?
	
	\BS\BS\BS\BS\BS\pause
	
	What's the news from campus?
	...
	{\color{Red}What's the news in \it physics?}
}
...
\frame{\frametitle{\textbf{Tycho Brahe}}
	...
	\begin{columns}
		...
		\it \scriptsize Small bull moose in Cape Breton, Nova Scotia, Canada. 
		\EC
