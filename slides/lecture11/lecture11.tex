...
\EC
\Large
\begin{flushright}--Paritosh Jain\end{flushright}
...
\item The exclusion principle, holding up the white dwarf left behind on the Sun, acts more strongly on heavy particles.
...
Some pictures: \url{http://abyss.uoregon.edu/\~js/ast122/lectures/lec19.html}
...
\Large
We will do something else after this (10-15 min)
\EC
}
...
\Huge 
Do you think Kepler's laws can apply to things other than planets? Why or why not?
\vspace{1in}

\Large
Talk about this with your neighbors. Then write what you think on Slack! (If you and your neighbors have the same idea, only send one message, and tag your neighbors.)
\EC
}
