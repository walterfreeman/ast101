...
\Large
\BC Exam 2 is next Thursday. That means:\EC
\BI
...
Next week's prelab is available online; paper copies will be available by the end of the day today.
\pause

\BS\BS

I am behind answering messages. I hope to catch up tomorrow morning. Sorry!
}
...
\color{Red}
... but we need a {\it supercomputer} to do that, and it takes either very hard math 
or a computer simulation to even get Kepler's second law out of them! 
...
\Large
How much kinetic energy does the pendulum have when I hold it?
...
After this, we'll discuss Exam 2 from last year.
\EC
}
