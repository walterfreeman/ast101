...
\Large
\BI
\item{Free response components of exam being returned in lab this week}
\item{Full exam scores available this week or next; my illness slowed down Scantron processing}
\item{Next {\it Mastering Physics} assignment posted tonight}
\item{Writing assignment due October 10}
...
\item{Recognized that any model had to agree with observation}
\item{\bf Increasingly saw astronomy as a separate discipline from natural philosophy!}
\EI
}
...
\includegraphics[width=0.4\textwidth]{parallax.png}
\bigskip
\bigskip
...
\large
Claudius Ptolemy lived in Alexandria, Egypt (then the center of scholarship in that part of the world) in the 2nd century CE.
...
\color{D}D: There is an abstract truth about nature, and a true model might predict other things we didn't expect\\
}



\frame{\frametitle{\textbf{From Egypt to Europe by way of Islam}}
\Large
...
Ptolemy's model, and made enormous strides in {\it mathematics} (Arabic numerals, {\it al-jabr} (algebra), etc.)
