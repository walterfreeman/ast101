...
\Large
\BI
\item Quiz 5 Retake + 6 as last half of class today
\BS
\item Lab section swaps next week
\BS \pause
\item Final projects
\EI
}

\frame{\frametitle{\textbf{Final projects}}
	Your final project in this class is a chance to combine astronomy with something of yourself.
	
	\BS
	
	There is a long list of prompts on the course website, but many of you will choose something else -- your {\it own} ideas. 
	...
	\BI
	\item Art projects
	\item A marching band show 
	\item Musical performances and composition
...
The best final projects for this class are ones that combine astronomy (or science generally) with one of your other interests or talents.

\BS\BS\BS

As with the papers in this class, we do ``open-ended'' grading for these (you can earn more than 100\% for exemplary or inspiring work).

\BS\BS\BS

Many students in the past have found this opportunity to be inspiring and rewarding -- we hope you will too!
}
...
\Large
\BC
If you smash hydrogen nuclei together hard enough, they fuse to make helium plus a {\it lot} of energy.
