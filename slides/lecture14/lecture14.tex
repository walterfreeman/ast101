...
\Large
\BI
\item Your second exam is Thursday
\item Material from today's class {\it \color{Red}will} be on the exam (both parts)
\item Material from this week's lab {\color{Red} will not} be on the exam
\item You may bring one handwritten side of one page of notes, as before
\item I will accept suggestions for questions for the exam (for extra credit) until 8am tomorrow
\EI
...
\pause
\BC
{\color{B}Please welcome Ohana Benevides, our guest speaker!}

\BS
She is a PhD candidate (and former AST101 TA) studying the physics of neutrinos, subatomic particles produced in nuclear reactions.

\BS

There are only {\it two} ways to learn about the stars that don't involve measuring light from the sky, and
