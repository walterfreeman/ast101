...
Scott's email: & \href{mailto:sdbassle@syr.edu}sdbassle@syr.edu \\
Course email: & \href{suastronomy101@gmail.com}suastronomy101@gmail.com
\end{tabular}
}
\frame{\frametitle{\textbf{Introduction}}
\Large
...
My email: & \href{mailto:wafreema@syr.edu}{wafreema@syr.edu} \\
Scott's email: & \href{mailto:sdbassle@syr.edu}sdbassle@syr.edu \\
\color{white}Course email: &\color{white} \href{suastronomy101@gmail.com}suastronomy101@gmail.com
\end{tabular}
}
...
\color{B}B: Social sciences / Maxwell \\
...
\color{B}B: Liberal arts / philosophy \\
...
\color{white}B: Liberal arts / philosophy \\
...
\Large
\BI
\item{Labs start on the {\bf third week of class}}
\item{Take-home labs assigned next week}
\item{Labs meet in Holden Observatory, led by TA's}
\EI
}

\frame{\frametitle{\textbf{Course components: Mastering Astronomy homework}}
\large
\BI
\item{Online homework system, at \url{https://masteringastronomy.com}}
\item{You should have gotten a code with your book; if not, you can buy one}
\item{Stuff you need to do}
\begin{enumerate}

\large \color{Green}
\item{Go to \url{https://masteringastronomy.com}}
\item{Register an account, using course ID SUASTRO101FALL2016}
\item{Enter an access code, or buy one}
\end{enumerate}
\item{The first homework assignment isn't graded, but is a dry run to get you familiar with the system}
\item{It's due next Tuesday and should take less than a half-hour}
\EI
}
...
\pause
\item{Writing assignments, more open-ended than the {\it MA} homework}
\pause
\item{Exams}
\pause
\item{Lots of details in the syllabus}
\pause
\item{Observing the stars...}
\BI
\item{At Holden Observatory?}
\item{... out in the Adirondacks?}
\EI
\EI
}
...
\item{Email me and ask for help: suastronomy101@gmail.com}
\item{Come to help sessions: Tuesdays, 4:30-6:30, and Fridays, 9:30-11:30}
\item{Come bang on my office door (room 215)}
\item{If you have questions you'd like addressed (``ask the physicist!''), or course suggestions, please send them to me!}
\EI
}
...
\Large
\centerline{\url{https://youtu.be/PrIk6dKcdoU}}
...
\item{Register for Mastering Astronomy}
\item{Bring your colored cards {\it and Lecture Tutorials} on Thursday}
\item{If we have a clear night, look up!}
\EI
}
...
When they mix them, though, we get Monty Python...
\pause
\url{https://walterfreeman.github.io/ast101/galaxy-song.mp3}
\end{center}
}
\end{document}
