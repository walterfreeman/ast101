...
\title[Planets and their atmospheres]{
  \textbf {Planets and their atmospheres}}
...
\frame{
	...
	My life is forever connected with aviation. I cannot live without the sky. I dream that perhaps one day I will lift a peaceful aircraft into space.
	...
	\begin{flushright}
		--Іван Кожедуб (Ivan Kozhedub), Ukrainian fighter pilot, \\	\normalsize
		 top-scoring fighter-pilot ace of World War 2, from his 1969 memoirs
	\end{flushright}
...
\large
\BI
\item No prelab next week (we don't want you to have to do one over Thanksgiving)
\item Office hours/help session tomorrow, 12-2pm
\item Please continue to send me project ideas!
\EI
}
...
\frame{
	...
	\begin{tabular}{@{}l | lllll@{}}
		...
		Mercury & 0.39                & 2440        & 700 / 100 K   &  \color{A}439 K & Long ago                \\
		Venus   & 0.72                & 6051        & 740 K         &  \color{A}321 K & Yes                \\
		Earth   & 1                   & 6378        & 290 K         &  \color{A}273 K & Yes                \\
		Mars    & 1.52                & 3397        & 220 K         &  \color{A}222 K & In the past              \\ \bottomrule
	\end{tabular}
	...
	\color{A} ``Temp (pred)'' is the temperature you predicted in Lab 10 -- \\ what you get if the planet is just a rock in space.
	
	\BS\BS
	\color{B} $\Delta$ Temp is the difference between the actual temperature of the planet and the temperature that your calculation in Lab 10 predicted.
...
\frame{
	...
	\BI
	\item Incoming sunlight -- visible
	\item Outgoing ``earthlight'' -- infrared
	\EI
