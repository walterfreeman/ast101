...
\frame{\frametitle{\textbf{Announcements - homework quiz today}}
\Large
\BI
\item Homework Quiz 4 will be at the end of class today. It should take you only a few minutes.
\item Turn it in at the {\it front} of the room.
\item Are there any questions about Homework 4?
\EI
...
\frame{\frametitle{\textbf{Exam format}}
	...
	\BI
	\item Ten multiple choice questions, emphasizing the emergence of heliocentrism
	
	\item Four free-response questions:
	\BI
...
\frame{\frametitle{\textbf{Announcements - I am running behind :(}}
	\large
	
	\BC
	I have been sick recently, and so has a member of my family.
	
	\BS\BS
	
	This means I've been running a bit behind since late last week. I will catch up as I'm able.
	\EC
}
