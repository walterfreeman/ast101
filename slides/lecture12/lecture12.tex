...
\Large
\BI
\item The prelab for this week originally contained an error; I've fixed it now
\item The next paper will be assigned in a week or so, and will be due three weeks after that

\item {\bf Our Exam 2 is next Thursday}
\EI
}

\frame{\frametitle{\textbf{Exam 2}}
\Large
\BC Exam 2 is next Thursday. Reminders:\EC

\bigskip
\BI
\item You may bring a single-sided page of notes, as before
\item I'll be holding an extra review on Monday from 2PM-5PM
\item Last year's Exam 2 is posted; the answer key will be posted Monday
\item The study guide is posted, too
\EI
}
...
\frame{\frametitle{\textbf {(I wrote this slide last year)}}
\large
\color{A}
