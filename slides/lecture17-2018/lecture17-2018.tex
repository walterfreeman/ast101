...
\Large
\BI
\item Exam 3 two weeks from today
\pause
\item Solutions to Exam 2 are posted (had to wait on people to finish) 
\item Final projects assigned today
\item Special warmup question for Thursday for a point of extra credit (not quite ready yet; it's a for a student's paper!)
\EI
}
...
\Huge
Find an overlap between astronomy and your other talents...

\BS

... create something combining the two ...

\BS\begin{center}
... and make it fantastic.\end{center}
}
...
Here's a sample atom (on the document camera). These energy levels aren't real; I just made them up for demonstration.
