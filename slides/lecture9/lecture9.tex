...
\frame{\frametitle{\textbf{Announcements}}
	...
	\BI
	\item We are still grading your exams. 
	\BI
	\item We'll have a grade distribution and statistics for you Tuesday
	\item In general it looks like people did reasonably well
	\item Some folks did better than others
	\item If you didn't do as well as you hoped, there is plenty of semester left
	\EI
	\BS
	\BS
	\item See your email for details on quiz makeups/retakes, and this week's survey
	
	\BS\BS
	
	\item Prelabs won't be available until tomorrow -- sorry about that!
	\EI}
...
\frame{\frametitle{\textbf{Last time}}
	...
	\begin{columns}
		...
		\item{Earth and humanity at center (and thus ``acceptable'' to the Church)}
		\item{\color{Red}Very accurate predictions}
		\EI
		\column{0.5\textwidth}
		\small
		\BC \includegraphics[width=0.66\textwidth]{ss-modern.jpg} \EC
		\BI
...
\frame{\frametitle{\textbf{Enter Galileo}}
	...
	He believed that the best way to get information is to {\it go measure stuff}, and pioneered a new tool to do that.
	...
	He pointed his telescope at Jupiter, and saw this:
...
\it \footnotesize The moons of Jupiter, imaged by ComradeWilheim (AST101 student) -- smartphone + telescope\EC
...
\item{No (or very small) epicycles}
\item{\color{Red}Less accurate than Ptolemaic model}
\item{\color{B}Matched Galileo's observations:}
\BI
\item{\color{B}Moons of Jupiter}
\item{\color{B}Phases of Venus}
\EI
\EI
\end{columns}
}
...
\pause
\item{Spent more time grooming than any of us}\pause

\BS

\item ``The Elon Musk of the Renaissance'' -- a wisecracker on Twitter
\BI
\item (This is not a compliment)
\EI
...
\frame{\frametitle{\textbf{Tycho Brahe}}
	...
	\begin{columns}
		...
		\item{Levied huge taxes on peasants to pay for it}
		\item{Lost a big chunk of his nose in a duel and got a brass replacement made}
		\item{Spent more time on grooming than any of us}
		\BS
...
\item{Made these measurements with his sister Sophie...}
...
\item{\color{C}... reject the observations made at Uraniborg as inconsistent with our model?}
