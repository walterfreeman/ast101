...
\frame{\frametitle{\textbf{Announcements}}
	...
	\BC
	Your next homework assignment will be posted later today, and due in one week. It will cover today's class and Thursday's.
	\EC
...
\frame{
	...
	\color{A}A: 3 eV\\ \BS
	\color{B}B: 4 eV, 3 eV, 2 eV, or 1 eV\\ \BS
	\color{C}C: 3 eV, 2 eV, or 1 eV\\ \BS
	\color{D}D: 4 eV \\ \BS
...
\color{A}A: 0.4 eV (Red) \\
\color{B}B: 12.5 eV (Ultraviolet) \\
