...
\Large
\BI
\item Paper 1 will be assigned next Tuesday 
\pause
\item Lab section swaps will be accepted until next Friday:
\BI
\item Go to Myslice and ensure that the section you want to swap into has open seats
\item Get a change of schedule form from the Registrar
\item Go to Melissa Wike (room 201) and ask her to approve your swap 
\EI 
\EI
}
...
\frame{\frametitle{\textbf{An earth-shattering kaboom!}}

\Large
So, tell me about those inflatable Earths:

\bigskip
\bigskip

\color{A}A: I have one (and it's with me today) 
\bigskip
\color{B}B: I went to the bookstore yesterday, and they were out 
\bigskip
\color{C}C: They were out last time I checked, but that was at least a few days ago
}
...
\Large
Questions about the {\it Lecture Tutorials?} Come ask us for help.
...
Come by the Clinic, Physics Building 112, and ask questions! (Office hours Friday will be held there.)
}
