...
\frame{
\BC\includegraphics[width=0.9\textwidth]{solarspectrum.jpg}
\BS

\it We are stardust; we are golden; we are billion-year-old carbon \\
And we got to get ourselves back to the garden.

\rm \BS\begin{flushright} --``Woodstock'', as performed by Crosby, Stills, Nash, and Young (1970)\end{flushright}
...
\large
\BI
\item The due date for Paper 2 is extended until the end of the day {\bf \color{Red} Monday, November 8.}
\item If you have questions about your paper, come to office hours or ask in {\tt \#paper-questions} on Discord.
\pause
\bigskip
\item If you are looking for extra help with your paper, bring it to office hours or send it to Kiersten Edwards, our writing coach, at {\tt kedwar03@syr.edu} or on Discord.
\EI
\pause\BS\BS\BS
...
\frame{\frametitle{\textbf{Announcements}}
	...
	\BC
	Your next homework assignment is included with today's exercises in class. It is due {\bf next Thursday} before class.
	
	\BS\BS\pause
	
	The prelab for next week's lab is very important, so you should make sure you do it. It is posted on the course website under ``Labs'', as usual.
	\EC
}
