...
\item Use the invite link there to join the Slack team
...
you can do it on MySlice. If you need more information, talk to Juliette Rawda (pga@syr.edu) in room 201.
...
\frame{\frametitle{\textbf{Talking about the sky -- last year's students}}
\BI
...
\item {\color{Red}In one year} the Earth orbits the Sun.
	\pause
\item {\color{Red}It takes tens or hundreds of thousands of years} for the stars to move appreciably relative to us.
	\EI
}
