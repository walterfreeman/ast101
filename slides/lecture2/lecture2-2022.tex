...
\item Use the invite link sent by email join the Discord server if you wish
...
\frame{\frametitle{\textbf{Labs next week}}
	...
	Usually, we will have prelabs for you on the previous Thursday. 
	
	\BS
		
	However, because of some technical issues on our end, the prelab won't be ready until tomorrow. Sorry about that!
	
	\BS
	
	We will have printed copies for you in room 112, or you can download it on your own.
}
...
\item Monday, 10 AM-12 PM
\item Walter's office hours: Friday, 2-4 PM (I think)
...
\frame{\frametitle{\textbf{Some announcements}}
\Large
Lab section changes are tricky because things are very full. We can't run lab sections over capacity; there is physically no room.
...
\frame{\frametitle{\textbf{Homework and sundry}}
	\Large
Your first homework assignment is included in the Exercises you will get today.

\BS

You won't turn your homework in. Instead:

\BI
\item Each homework set will ask you a series of questions. 
\item On the day when it is ``due'', you'll have a quiz in class 
\item The questions on the quiz will be extremely similar to the homework...
\item ... and the homework will say exactly what form they will take.
\EI
...
\small{Taken in summer 2017: ISO 6400, f/1.8, 13 seconds}\EC}

\frame{\frametitle{\textbf{Talking about the sky -- students in the past}}
\BI
...
\frame{\frametitle{\textbf{Virtual planetarium software}}
	...
	\pause\BS
	\item{Mac users: see the link on the website (should be compatible with both M1 and Intel Macs)}
	\EI
}
...
\frame{\frametitle{\textbf{Drawing the sky: a demo}}
	
	\Large
	\BC
	One critical skill in science is drawing diagrams. Rather than just show them to you, 
	I'm going to show you the process of drawing them.
	\EC
	
}

\frame{\frametitle{\textbf{In-class exercise}}
	\Huge
	\BC
