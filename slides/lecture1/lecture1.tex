...
\item{Lead TA: Suman Kumar Kundu}
\item{Other TA's...}
...
Suman's email: & \href{mailto:skundu@syr.edu}skundu@syr.edu \\
\end{tabular}
}
\frame{\frametitle{\textbf{Introduction}}
\Large
...
\frame{\frametitle{\textbf{Slack}}
\Large
We will be using Slack as a communication tool in our course. It's commonly
used for professional collaboration in many business settings.

\BS

It combines the good features of email and group messaging; it's basically
...
I will have my laptop running Slack on the podium each day, and will respond to comments
and questions that you ask there. (You can of course raise your hand or just shout out 
questions, too!)
}
...
\Large
\BC
If you ever forget your card, click on the ``Forgot your response cards?'' link on the website.
...
\pause
\item{In-class short quizzes (really a proxy for attendance)}
\pause
\item{Exams}
\pause
...
The first chapter of your textbook goes into a lot more detail; you should read it.
...
\item Join the course Slack team
