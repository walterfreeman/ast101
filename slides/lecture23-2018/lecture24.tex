...
\BCC
\HC
\includegraphics[width=0.9\textwidth]{meme.jpg}
\HC
\Large
\BS

This meme popped up on my Facebook feed at this time last year...
...
\BS
\color{A}A: Ridiculous\\
\color{B}B: Wasteful\\
\color{C}C: Heartwarming\\
\color{D}D: Awesome\\
\pause
\color{E}E: Human
\ECC
...
\BC
\Large We just landed another robot on Mars!
...
\item If you take your exams at ODS, get your project to me before/after (I'll be around)
\EI
\EI
}
...
\frame{\frametitle{\textbf{Announcements}}
\Large
I am behind on answering mail.

\BS

I hope to be caught up with mail you all have sent me in the last few days by tomorrow at noon.
}

\frame{\frametitle {\bf Preparing for the final exam}
\large
\BI
\item The final exam is next Tuesday, 3PM - 5PM, 11 December
\item {\color{Red} Section 1 (12:30): Grant Auditorium (Falk)}
\item {\color{Green} Section 2: (2:00): Stolkin Auditorium (here)} 
\item Exam will be around 50 multiple choice questions
\BI
\item Roughly half will cover Unit IV
\item The other half will be comprehensive
\item This will focus on the big-picture ideas
\EI
\EI
}
...
\large
\BI
\item Lab all this week (to review Unit 3)
\item Wednesday: office hours 3-5 
\item Friday: office hours 9:30-11:30
\item Sunday: 4-7 PM, Hall of Languages 102 (led by Anna)
...
\large
\BI
\item I anticipate finishing all my backlog of grading tonight or tomorrow morning.
\item I'll send out an email when this is done; at that point, your grades should be on Blackboard.
\BI
\item This doesn't include Exam 3 corrections or incidental extra credit
\EI
\BS
...
\item 1961: Soviets launch Venera to Venus (it broke before arriving)
...
\item 1986: USSR launches Space Station Мир (``Peace''); it crashes in 2001
\item ... and more
\EI
}
...
\HC
\BC
\includegraphics[width=0.7\textwidth]{CLEP.png}
\EC
\ECC
}
...
\item The energy from that reactor makes rocket fuel for the return trip
\EI
\EI
}
