...
\item This time, only email if you can't turn it in physically 
\EI
}
...
\large
\BI
\item The final exam is next Tuesday, 3PM - 5PM, 12 December
\item {\bf Section 1: Stolkin Auditorium (here)}
\item {\bf Section 2: Watson Theater (Watson Hall)} 
...
\item Sunday: in the Physics Clinic here from 6:30-9
...
\item Several clever ways to use robotics to reduce the size of the rockets needed
\EI
...
\large
{\it Voyager 1} and {2} are headed for the stars, but won't make it near any for tens of thousands of years.
...
\pause
\item Barack Obama was elected the width of a pen in the past
\pause
...
of the lead LIGO scientists here.
...
\frame{\frametitle{\bf Going beyond (2/3): My course next semester}
\BCC
\HC
\includegraphics[width=\textwidth]{pom.jpg}

\HC
\BC
\Large
I'm teaching a course next term on the physics of music.

\BS

It's intended for non-STEM majors (musicians -- and you!)

\BS

It's going to be a much smaller class than this one...
\EC
\ECC
}
